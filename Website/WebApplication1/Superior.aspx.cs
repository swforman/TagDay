	...
	public partial class Superior : System.Web.UI.Page
	{
		...
		private void BindData()
		{
			RegionInfo[] arr1 = new RegionInfo[] {
					...
					new RegionInfo("S-6", 39.921207, -105.163304),
					new RegionInfo("S-7", 39.938995, -105.160257),
					new RegionInfo("S-8", 39.942433, -105.154871),
					new RegionInfo("S-9", 39.943765, -105.149764)
			};
