	...
	public partial class Louisville : System.Web.UI.Page
	{
		...
		private void BindData()
		{
			RegionInfo[] arr1 = new RegionInfo[] {
				...
				new RegionInfo("L-6", 39.9749,-105.134979),
				new RegionInfo("L-7", 39.974802, -105.142404),
				new RegionInfo("L-8", 39.976725, -105.147403),
				new RegionInfo("L-9", 39.978715, -105.134658),
				new RegionInfo("L-10", 39.980680, -105.148348),
				new RegionInfo("L-11", 39.977646, -105.159355),
				new RegionInfo("L-12", 39.974456, -105.166758),
				new RegionInfo("L-13", 39.984897, -105.160149),
				new RegionInfo("L-14", 39.988514, -105.15957),
				new RegionInfo("L-15", 39.989813, -105.143691),
				new RegionInfo("L-16", 39.992673,-105.138026)
			};
